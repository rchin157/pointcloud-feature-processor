...
def getitsc(ct, pt, dim, v=None):
    ...
    if dim == 'x':
        ...
        a = ct[0]*v[0]**2 + ct[1]*v[1]**2 + ct[2]*v[2]**2 + 2*ct[3]*v[0]*v[1] + 2*ct[4]*v[1]*v[2] + 2*ct[5]*v[0]*v[2]  # (av1^2 + bv2^2 + cv3^2 + 2ev1v2 + 2fv2v3 + 2gv1v3)t^2
        ...
        c = ct[0]*pt[0]**2 + ct[1]*pt[1]**2 + ct[2]*pt[2]**2 + 2*ct[3]*pt[0]*pt[1] + 2*ct[4]*pt[1]*pt[2] \
